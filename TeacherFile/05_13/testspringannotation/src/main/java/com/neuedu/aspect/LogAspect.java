...
public class LogAspect {
	 ...
	 * AOP: many concepts, 
	 * 
	 * advice(通知): before, after(finally), after-throwing(works in case of exception), after-returning(works when this is no exception), around(in spring, it is always a method in a aspect)
	 * 
